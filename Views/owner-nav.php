<div>
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item"> <a class="nav-link" href="<?php echo FRONT_ROOT ?>Owner/AddView">Add Owner</a> </li>
    <li class="nav-item"> <a class="nav-link" href="<?php echo FRONT_ROOT ?>Owner/ListView">Owner's List</a> </li>
    <li class="nav-item"> <a class="nav-link" href="<?php echo FRONT_ROOT ?>Pet/OwnerAddView">Add Pet</a> </li>
    <li class="nav-item"> <a class="nav-link" href="<?php echo FRONT_ROOT ?>Pet/OwnerListView">Pet's List</a> </li>
