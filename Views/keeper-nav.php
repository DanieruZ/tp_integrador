<div>
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item"> <a class="nav-link" href="<?php echo FRONT_ROOT ?>Keeper/keeperShedule">Schedule</a> </li>
    <li class="nav-item"> <a class="nav-link" href="<?php echo FRONT_ROOT ?>Pet/KeeperListView">Pet's List</a> </li> 
