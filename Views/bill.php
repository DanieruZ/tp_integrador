    ...
    <div class="100cont">
      <div class="contPrimInfo">
        <div class="lineaCont">
          ...
          <div class="leftCont2"><?php echo $person->getLastname();
                                  echo " ";
                                  echo $person->getFirstname(); ?></div>
        </div>
        <div class="lineaCont">
        ...
        <div class="lineaCont3">
          ...
          <div class="lineaDescuentos">
            ...
            <b>
              <div class="leftCont6">$<?php echo $totalCost * 0.05; ?></div>
            </b>
          </div>
          ...
          <div class="lineaDescuentos">
            ...
            <b>
              <div class="leftCont6">$<?php echo $totalCost * 0.12; ?></div>
            </b>
          </div>
          ...
          <div class="lineaDescuentos">
            ...
            <b>
              <div class="leftCont6">$<?php echo $totalCost / 2; ?></div>
            </b>
          </div>
